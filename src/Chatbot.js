...
function ChatBot() {
  ...
  const mensajeNuevoEnviado = () => {
    ...
    const mensajePorEnviar = {
      numeroMensaje: mensajeId,
  ...
  const enviarMensaje = async () => {
    if (claseChat.current.value !== "") {
      ...
      sessionStorage.setItem(
        "Chat",
        JSON.stringify([...historial, mensajeFinal])
      );
    }
  };
  ...
  const guardarMensajeDelBot = (data) => {
    ...
    sessionStorage.setItem(
      "Chat",
      JSON.stringify([...historial, mensajePorEnviar])
    );
  };
  ...
  return (
    <div className="ChatBot">
      <div
        className={chatAbierto ? "d-none" : "chat-cerrado"}
      ...
      <div
        className={chatAbierto ? "chat-abierto" : "d-none"}
        onKeyDown={manejarEnterChat}
      >
                    ...
                    <div className="d-flex">
                      ...
                      >
                        ...
                        <div className="mensaje-contenido">
                          {data.contenidoMensaje.contenido}
                        </div>
                      </div>
                    </div>
                  </div>
