...
const NavBarAdmin = ({alumno}) => {
  ...
  return (
    <div className="containerN">
      <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-between" id="nav">
        ...
        <ul className="nav col-12 col-lg-auto me-lg-3 mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="/AdministrarProgramas/1" className="nav-link px-2 link-dark">Administrar Programas</a></li>
        </ul>
